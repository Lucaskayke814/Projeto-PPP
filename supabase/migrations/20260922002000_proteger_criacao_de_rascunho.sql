-- A regra de apenas um PPP editável por escola é aplicada no banco; o botão do
-- painel é somente uma orientação visual e não pode ser a única proteção.
...
begin
  ...
  -- O bloqueio ocorre sob uma trava da escola, evitando duas criações quase
  -- simultâneas por abas diferentes da mesma conta.
