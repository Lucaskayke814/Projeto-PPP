-- A sincronização é chamada em cada sessão Google. Um provisionamento já
-- aplicado não pode impedir o próximo login por violar o vínculo único.
...
begin
  ...
  if found then
    ...
    values(
      ...
      provisionamento.regional_ensino_id,
